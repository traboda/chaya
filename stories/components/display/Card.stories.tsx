        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-between gap-3">
            ...
            <p>
              ...
              aliquam ultricies, nunc nisl aliquet nunc, vitae aliquam nisl nunc vitae nisl Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Nullam euismod, nisl eget aliquam
              ultricies, nunc nisl aliquet nunc, vitae aliquam nisl nunc vitae nisl Lorem ipsum
              dolor sit amet, consectetur adipiscing elit. Nullam euismod, nisl
            </p>
          </div>
    ...
    children: (
      <Card title="Theme" description="Set theme for your store.">
        <div className="flex flex-col gap-3">
          ...
          <Card
            title="Font"
            description="Set font for your store. We support Google Fonts, and custom fonts."
          >
            <p>grand child card content goes here</p>
          </Card>
        </div>
