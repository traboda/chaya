  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {selections && (selections?.selectedIDs?.length || selections.excludedIDs?.length) ? (
        <div className="mx-0 flex flex-wrap rounded-t-lg border border-neutral-500/10 bg-gray-500/10 px-2 py-1 shadow dark:border-neutral-500/70 dark:bg-gray-500/20">
