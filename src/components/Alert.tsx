...
const alertClassName = cva({
  ...
  compoundVariants: [
    ...
    { variant: 'solid', color: 'black', className: 'dark:bg-neutral-800' },
    {
      ...
      color: 'white',
      className:
        'bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-600 border-opacity-100',
    },
    ...
    >
      ...
      {(primaryButton || secondaryButton) && (
        <div className="mt-2 flex items-center">
          {primaryButton && (
            <div className="mr-2">
              <Button color="primary" className="text-base" {...primaryButton} />
            </div>
          )}
          {secondaryButton && (
            <div>
              <Button color="secondary" className="text-base" {...secondaryButton} />
            </div>
          )}
        </div>
      )}
