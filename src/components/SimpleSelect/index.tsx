...
const SimpleSelect = <Type extends SimpleSelectValue | SimpleSelectValue[]>({
  ...
  return (
      <DropdownMenu.Root open={isDropdownActive} onOpenChange={setIsDropdownActive} modal={false}>
        <DropdownMenu.Trigger asChild className="hover:dsr-outline-none">
          <div
            ref={containerRef}
            className={clsx(['dsr-w-full simple-select-container dsr-overflow-hidden', isDisabled && 'dsr-opacity-70'])}
          >
